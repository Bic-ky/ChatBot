...
AUTHOR_NAME = "Bicky Yadav"
AUTHOR_EMAIL = "114137746+Bic-ky@users.noreply.github.com"
...
def main():
    ...
    if not temp_dir.exists():
        ...
        # First ensure we have current files
    ...
    run_git(["git", "checkout", "-f", "-B", "resequenced", BASE_COMMIT])
